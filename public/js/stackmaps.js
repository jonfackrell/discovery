...
window.stackmaps = {
  ...
  addMapLink: function addMapLink(item) {
  ...
  appendMapModal: function appendMapModal() {
    ...
    body.appendChild(modal); //MicroModal.init();
  },
  showMapModal: function showMapModal(item) {
    ...
    micromodal__WEBPACK_IMPORTED_MODULE_0__["default"].show('stackmaps-modal');
  },
...
/***/ 1:
/*!*****************************************!*\
  !*** multi ./resources/js/stackmaps.js ***!
  \*****************************************/
